...
public class MyDeckSort {
	public static void sort(MyDeck d) {
		...
		// 1. compare,swap, then move until youve been through all the numbers in the
		// array
		// will be closer to being sorted
		// 2. then what???
		// end with an N^2 algorithm, best possible (N^3 would be easy)
		// turn in and say ratio of growth (must be 4)
		// not like prev assignments. more thinking than coding
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < 10; i++) { // gives ratio of performance speeds
			N *= 2;
			d = new MyDeck(N);
			countops(d);
